...
const serverUrl = "https://7yil69citfq1.usemoralis.com:2053/server"; //Moralis Server Url here
const appId = "KM37ZoMx2ReTtSJ8Vv5omC4Ox6Vp6oqBKsmoiasG"; //Moralis Server App ID here
...
const collectionAddress = "0xef453154766505feb9dbf0a58e6990fd6eb66969"; //Collection Address Here
const collectionName = "MrCryptoByRacksMafia"; //CollectioonName Here
...
async function generateRarity() {
  ...
  allNFTs = allNFTs.filter((value, index, self) =>
  ...
  for (let j = 0; j < metadata.length; j++) {
    ...
    let rarityScoreNumTraits =
      6 * (1 / (tally.TraitCount[Object.keys(current).length] / totalNum));
    current.push({
